...
<table class='table table-bordered treetable'>
    <thead>
        <tr>
            ...
            <th class='header textCenter'>CNPJ</th>
    ...
    foreach ($arr as $row)
    {
        ...
        ?>
            <tr class='<?php echo $trStyle ?>'>
                ...
                <td class='textCenter'><?php echo $row["CNPJ"] ?></td>
...
{
    $msg = ob_get_contents();
    $to  = 'alertadocumentos@somaagricola.com.br' . "\r\n";
}
else
{
    $msg = "Script alertaDocumentos foi executado pelo cron";
}

ob_end_clean();

//$to      = 'ti@somaagricola.com.br' . "\r\n";
$subject = 'Alerta de vencimento de Documentos';
